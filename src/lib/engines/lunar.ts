/**
 * Âm lịch Việt Nam — thuật toán của Hồ Ngọc Đức, múi giờ UTC+7.
 * Không dùng lịch Trung Quốc (UTC+8) vì một số năm lệch ngày Tết (vd. 1985).
 */
...
export function solarToLunar({ day, month, year }: SolarDate, timeZone = VN_TIMEZONE): LunarDate {
